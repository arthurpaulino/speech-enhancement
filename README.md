...
a classifier. Unfortunately, this strategy is very prone to underfitting on a
...
generated by each of the models will be ensembled into a resulting spectrogram.
  ...
  and a brief summary of the experiment on the file `summary.txt`, both located
  at the experiment folder.
